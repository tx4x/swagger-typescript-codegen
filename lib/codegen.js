...
var getViewForSwagger2 = function (opts) {
    ...
    _.forEach(swagger.paths, function (api, path) {
        ...
        _.forEach(api, function (op, m) {
            ...
            method.methodName = method.methodName.replace('post','');
            method.methodName = method.methodName.replace('put','');
            method.methodName = method.methodName.replace(opts.className,'');
            method.methodName = camelCase(method.methodName);
